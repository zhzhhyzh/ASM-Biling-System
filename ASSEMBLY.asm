...
.DATA
    ...
    WELCOMEMSG      db   10,13, 10,13,"      ------------------------------------------------------------------- "
                    DB   10,13,"     |                     Hustler Billiard System                       | "
                    DB   10,13,"      -------------------------------------------------------------------  "
    ...
    LOGINPROMPT     db   10,13, 10,13,"      ----------------------- Enter Staff Password -----------------------                 $"
    PASSWORDPROMPT  db   10,13, 10,13,"      Enter Password: $"
    ...
    INVALIDINPUT    db   10,13, 10,13,"         INVALID INPUT OF NUMERIC VALUE!!!$"
    KEYMSG          db   10,13, 10,13,"                         Press any key to continue...$"
    ...
    MENU3           db   10,13, 10,13,"                 --------------------------------------------- "
                    DB   10,13, "                 |                Billiard Cues              | "
                    db   10,13, "                 --------------------------------------------- "
    ...
    P1HMSG          db   10,13, 10,13,"                       Pool rent for 1 hour added to bag $"
    P2HMSG          db   10,13, 10,13,"                       Pool rent for 3 hour added to bag $"
    S1HMSG          db   10,13, 10,13,"                       Snooker rent for 1 hour added to bag $"
    S2HMSG          db   10,13, 10,13,"                       Snooker rent for 3 hour added to bag$"
    PSHMSG          db   10,13, 10,13,"                       Daily Pass for Snooker(1)/Pool(0)?$"
    P3HMSG          db   10,13, 10,13,"                       Pool rent for DAILY PASS added to bag $"
    S3HMSG          db   10,13, 10,13,"                       Snooker rent for DAILY PASS added to bag$"
                     
    C1MSG           db   10,13, 10,13,"                       Pool Hard Cues added to bags$"
    C2MSG           db   10,13, 10,13,"                       Pool Smooth Cues added to bags$"
    C3MSG           db   10,13, 10,13,"                       Snooker Wooden Cues added to bags$"
    C4MSG           db   10,13, 10,13,"                       Snooker Solid Cues added to bags$"
                     
    F1MSG           db   10,13, 10,13,"                       Cheesy Wedges added to bag$"
    F2MSG           db   10,13, 10,13,"                       Fried Chicken Wings to bag$"
    F3MSG           db   10,13, 10,13,"                       Stirpan Maggi added to bag$"
    F4MSG           db   10,13, 10,13,"                       Aloha Chiken Pizza added to bag$"
                     
    D1MSG           db   10,13, 10,13,"                        Orange Juice added to bags$"
    D2MSG           db   10,13, 10,13,"                        Soft Drinks added to bags$"
    D3MSG           db   10,13, 10,13,"                        Nescafe White Coffee added to bags$"
    D4MSG           db   10,13, 10,13,"                        Boba Milk Tea added to bags$"
                     
                     
    OPTIONMSG       db   10,13, 10,13,"                       Choose Option: $"
    INVALIDOPTION2  db   10,13, 10,13,"                       Invalid Option. Please select 0 OR 1$"
    INVALIDOPTION4  db   10,13,"                    Invalid Option. Please select 1 to 4$"
    INVALIDOPTION5  db   10,13, 10,13,"                       Invalid Option. Please select 1 to 5$"
    QUANTITYMSG     db   10,13, 10,13, "                       Enter quantity (Max 3): $"
    INVALIDINPUTMSG db   10,13, 10,13,"                       Invalid Input. Enter the correct numeric"
                    DB   10,13,"                       value for quantity OR in range of 3. $"
    FROMMSG         DB   0
    ...
    SPACE           DB   " $"
    BILLMSG         DB   10,13,"------------------------------------------------------------------"
                    DB   10,13,"|                     RECEIPT GENERATE HERE                      |"
                    DB   10,13,"------------------------------------------------------------------$"
    ...
    FPRINT4         DB   " Aloha Chicken Pizza                            RM  60.00|$"
    ...
    PYMTINPUTMSG    DB   10,13,"------------------------------------------------------------------"
                    DB   10,13,"|                     CUSTOMER PAYMENT HERE                      |"
                    DB   10,13,"------------------------------------------------------------------"
                    DB   10,13,"Enter Customer Cash Payment (1234.56): RM$"
    PYMTOUTPUTMSG   DB   10,13,"Return Cash: RM $"
    ...
    DTMSG                 db   13,10,"                             **Login Successful**"
                    db   13,10,10,13,"                         Press any key to continue..."
                    db   13,10,"                       Current Date and Time: $"
...
MAIN PROC
    ...
    ;clear screen
                          ...
                          mov  bh,02h                      ;display attribute - colors(HERE CHANGE THE BG AND TEXT COLOR!!!!!!!)
...
JMP PASSWORD_LABEL
    ...
    ;clear screen
                          ...
                          MOV  DX,174FH
                          mov  al,00h                      ;number of lines to scroll
                          mov  bh,71h                      ;display attribute - colors(HERE CHANGE THE BG AND TEXT COLOR!!!!!!!)
                          mov  ch,00d                      ;start row
                          mov  cl,00d                      ;start col
                          mov  dh,24d                      ;end of row
                          mov  dl,79d                      ;end of col
